...
useEffect(() => {
  if (
    !userLoading &&
    (!user || (user.role?.name !== "Manager" && user.role?.name !== "Admin"))
  ) {
  ...
  axios
    ...
    .catch(() => setError("Failed to fetch team leave requests."))
  ...
  return (
    <div className="container py-4">
      ...
      {loading ? (
        ...
        <Alert variant="info">No leave requests found for your team.</Alert>
      ) : (
